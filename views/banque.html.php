    ...
    <div class="d-flex flex-column">
        ...
        <div class="list-group list-group-flush border-bottom scrollarea">
          <?php foreach($banques as $line): ?>
            ...
            <a href="/associate?banque_id=<?php echo $line->id?>" class="list-group-item list-group-item-action py-3 lh-sm" aria-current="true">
            <?php else: ?>
            ...
            <div class="row">
              <div class="col-8 mb-1 small"><?php echo $line->date; ?></div>
